...
public class CardEffect
{
    ...
    public EffectProperty effectProperty { get; private set; }
    ...
    public CardEffect(string _effectTarget, string _effectProperty, int _effectValue, int _distance, string _direction, int _successPercentage, bool _isAreaEffect)
    {
